...
const Home = () => {
  ...
  return (
    <div className="flex flex-wrap w-full h-[93vh]  md:h-[100vh] font-400 font-josefin-sans md:text-6xl text-4xl border-solid border-[2px] border-black bg-black relative cursor-pointer">
